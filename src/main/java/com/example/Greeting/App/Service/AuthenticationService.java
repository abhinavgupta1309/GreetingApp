...
import com.example.Greeting.App.Model.AuthUser;
import com.example.Greeting.App.Repository.AuthUserRepository;
import com.example.Greeting.App.Security.JwtUtil;
...
//    }
    public String registerUser(AuthUser authUser) {
        ...
        String content = "<h2>Hello " + authUser.getFirstName() + ",</h2>"
                + "<p>You have successfully registered in Greeting App</p>"
